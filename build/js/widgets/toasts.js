...
class Toasts {
  ...
  create() {
    ...
    if (this._config.close == true) {
      const toastClose = $('<button data-bs-dismiss="toasts" />').attr('type', 'button').addClass('ms-auto mb-1 btn btn-close').attr('aria-label', 'Close').append('<span aria-hidden="true"></span>')
