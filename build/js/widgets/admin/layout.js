...
const SELECTOR_SIDEBAR = '.main-sidebar .sidebar-body'
...
const SELECTOR_HEADER_CONTENT = '.main-header .header-content'
const SELECTOR_HEADER_CONTENT_RIGHT = '.main-header .header-md-content .header-right'
...
const CLASS_NAME_HEADER_CONTENT_EXPAND = 'header-content-expand'
const Default = {
...
class Layout {
    ...
    fixLayoutHeight(extra = null) {
        ...
        const heights = {
            ...
            content: $(SELECTOR_CONTENT).length > 0 ? $(SELECTOR_CONTENT).height() : 0,
        }
    ...
    _init() {
        ...
        $(SELECTOR_HEADER_CONTENT_RIGHT).on('click', () => {
            const $content = $(SELECTOR_HEADER_CONTENT)
            if ($content.hasClass(CLASS_NAME_HEADER_CONTENT_EXPAND)) {
                $content.removeClass(CLASS_NAME_HEADER_CONTENT_EXPAND)
            } else {
                $content.addClass(CLASS_NAME_HEADER_CONTENT_EXPAND)
            }
