...
class Prototype {
    ...
    static merge = function(target, ...arg) {
...
Prototype.extend(Array.prototype, Prototype.array);
 Prototype.extend(String.prototype, Prototype.string);
